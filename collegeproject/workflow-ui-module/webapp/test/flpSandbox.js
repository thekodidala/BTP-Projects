		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#lecturerApprovalUIworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lecturerApprovalUIworkflowuimodule-display": {
								"semanticObject": "lecturerApprovalUIworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lecturerApprovalUI.workflowuimodule",
									"url": sap.ui.require.toUrl("lecturerApprovalUI/workflowuimodule")
								}
							}
						}
					}
