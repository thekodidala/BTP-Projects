		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lecturer Approval Form Task UI app title",
									"targetURL": "#lecturerApprovalworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lecturerApprovalworkflowuimodule-display": {
								"semanticObject": "lecturerApprovalworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lecturerApproval.workflowuimodule",
									"url": sap.ui.require.toUrl("lecturerApproval/workflowuimodule")
								}
							}
						}
					}
